...
class DataSourceCallsAggregationAspectTest {
    ...
    void aggregateCallsTest() throws Throwable {
        ...
        when(firstDefinition.name()).thenReturn(firstDatabaseName);
        when(secondDefinition.name()).thenReturn(secondDatabaseName);
        ...
        verify(firstDefinition, times(1)).name();
        verify(secondDefinition, times(1)).name();
